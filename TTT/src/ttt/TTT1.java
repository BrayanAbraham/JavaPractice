...
ic1=new ImageIcon("src/resources/o.jpg");
ic2=new ImageIcon("src/resources/x.jpg");
ic11=new ImageIcon("src/resources/o.jpg");
ic22=new ImageIcon("src/resources/x.jpg");
...
for(i=0;i<=7;i++){
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();
	...
	JOptionPane.showMessageDialog(TTT1.this,"!!!Player O won!!! click reset");			 break;
                   }
             else if(icon1==ic2){ 
             b[(a[i][1]-1)].setIcon(ic22);
             b[(a[i][2]-1)].setIcon(ic22);
             b[(a[i][3]-1)].setIcon(ic22); 
               JOptionPane.showMessageDialog(TTT1.this,"!!!Player X won!!! click reset");
                break;			 
               }
         }
    }  
